    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ibtn21.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                rr.vibrate(50);
                respuestaHttp = httppost.post("P6", txt_respuesta21, MetodosSharedPreference.getSucursalPref(prs), "Movil", "-");
        ...
        ibtn22.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                rr.vibrate(50);
                respuestaHttp = httppost.post("P6", txt_respuesta22, MetodosSharedPreference.getSucursalPref(prs), "Movil", "-");
        ...
        ibtn23.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                rr.vibrate(50);
                respuestaHttp = httppost.post("P6", txt_respuesta23, MetodosSharedPreference.getSucursalPref(prs), "Movil", "-");
